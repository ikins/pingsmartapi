...
<button type="button" class="btn btn-default" data-toggle="modal" data-target="#mdNilai"><i class='fa fa-check'></i> Input Nilai Siswa</button>


<?php
Modal::begin([
	'id' => 'mdNilai',
	'header' => '<h5>Input Detail Nilai</h5>',
	'options'=>[
		'data-url'=>'cubic',
		],
]);
...
$urlInc = Url::to(['/guru/nilai-add-detail']);
$urlDel = Url::to(['/guru/nilai-remove-detail']);
$script = <<< JS
