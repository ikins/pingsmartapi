			...
			<?= GridView::widget([
				...
				'columns' => [
					...
					[
						...
						'vAlign' => 'middle',
						'value' => function ($model, $key, $index) { 
							if($model->KodePlan !== ''){return $model->plan->Plan;}else{return '';}
						},
					],
					[
						'label' => 'Masa Aktif',
						...
						'value' => function ($model, $key, $index) { 
							...
							return '<div class="btn-group">
								  ...
								  <ul class="dropdown-menu">
									<li>'.Html::a('<i class="fa fa-folder-open"></i> Tampilkan',['view','id'=> $model->Id]).'</li>
									<li>'.Html::a('<i class="fa fa-pencil"></i> Ubah',['update','id'=> $model->Id]).'</li>
									<li role="separator" class="divider"></li>
									<li>'.Html::a('<i class="fa fa-ban"></i> Blokir',['block','id' => $model->Id],[
