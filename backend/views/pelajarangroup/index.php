...
$this->title = 'Group Pelajaran';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="pelajaran-group-index">
	<div class='box box-default'>
		<div class='box-header with-border'>
			<h1>
				<?= Html::encode($this->title);?>
				<?= Html::a('Input Group', ['create'], ['class' => 'btn btn-success pull-right']) ?>
			</h1>
		</div>
		<div class='box-body'>
            ...
            <?= GridView::widget([
				...
				'columns' => [
					...
					[
                        ...
                        'vAlign' => 'middle',
                        'value' => function ($model, $key, $index) {
                             return Html::a($model->Group, ['view', 'id' => $model->Id]);
                        }, 
                    ],
